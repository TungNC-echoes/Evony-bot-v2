...
def auto_join_rally(device_id=None, use_general=True, use_assistant_general=False):
    ...
    if use_general and use_assistant_general:
        war_type += " + tướng phụ"
    ...
    while True:
        try:
            ...
            if use_general:
                if join_war_sequence(device_id, use_assistant_general=use_assistant_general):
    ...
    while True:
        try:
            ...
            if check_button_exists("join_button", device_id=device_id):
                ...
                if use_general:
                    if continue_war_sequence(device_id, use_assistant_general=use_assistant_general):
                        print("Đã hoàn thành chuỗi hành động tham gia chiến tranh")
                    else:
                        print("Không thể hoàn thành chuỗi hành động tham gia chiến tranh")
                else:
                    ...
                    for boss_info in boss_positions:
                        ...
                        if join_button_pos:
                            ...
                            if tap_screen(join_x, join_y):
                                ...
                                if use_general:
                                    war_success = join_advanced_war_sequence(
                                        device_id,
                                        selected_bosses,
